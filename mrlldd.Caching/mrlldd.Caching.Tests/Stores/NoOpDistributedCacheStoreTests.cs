...
namespace mrlldd.Caching.Tests.Stores
{
    ...
    public class NoOpDistributedCacheStoreTests : TestBase
    {
        ...
        private ICacheStoreOperationMetadata OperationMetadata { get; set; }
        ...
        protected override void AfterContainerEnriching()
        {
            ...
            OperationMetadata = new CacheStoreOperationMetadata(Faker.Random.Number(0, 99999), Faker.Random.String(0, 32));
        ...
        [Test]
        public void FailOnGet() => Container
            .Effect(c =>
            {
        ...
        [Test]
        public Task FailOnGetAsync() => Container
            .EffectAsync(async c =>
            {
                var store = c.GetRequiredService<ICacheStoreProvider<InDistributed>>().CacheStore;
        ...
        [Test]
        public void SuccessOnSet() => Container
            .Effect(c =>
            {
                var store = c.GetRequiredService<ICacheStoreProvider<InDistributed>>().CacheStore;
        ...
        [Test]
        public Task SuccessOnSetAsync() => Container
            .EffectAsync(async c =>
            {
                var store = c.GetRequiredService<ICacheStoreProvider<InDistributed>>().CacheStore;
        ...
        [Test]
        public void SuccessOnRefresh() => Container
            .Effect(c =>
            {
                var store = c.GetRequiredService<ICacheStoreProvider<InDistributed>>().CacheStore;
        ...
        [Test]
        public Task SuccessOnRefreshAsync() => Container
            .EffectAsync(async c =>
            {
                var store = c.GetRequiredService<ICacheStoreProvider<InDistributed>>().CacheStore;
        ...
        [Test]
        public void SuccessOnRemove() => Container
            .Effect(c =>
            {
                var store = c.GetRequiredService<ICacheStoreProvider<InDistributed>>().CacheStore;
        ...
        [Test]
        public Task SuccessOnRemoveAsync() => Container
            .EffectAsync(async c =>
            {
                var store = c.GetRequiredService<ICacheStoreProvider<InDistributed>>().CacheStore;
