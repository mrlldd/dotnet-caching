...
namespace mrlldd.Caching.Tests.Loaders
{
    public abstract class CacheStoreCallTestFixture : CachingTest
    {
        ...
        [Test]
        public Task LoadsIfStoreMissAsync()
        {
            return Container
        ...
        [Test]
        public void LoadsIfOmittingCache()
        {
            Container
                .Effect(c => WithExactOperationsCount(() =>
                {
        ...
        [Test]
        public void GetsIfNotOmittingCache()
        {
            Container
                .Effect(c => WithExactOperationsCount(() =>
                {
        ...
        [Test]
        public Task LoadsIfOmittingCacheAsync()
        {
            return Container
                .EffectAsync(c => WithExactOperationsCountAsync(async () =>
                {
        ...
        [Test]
        public Task GetsIfNotOmittingCacheAsync()
        {
            return Container
                .EffectAsync(c => WithExactOperationsCountAsync(async () =>
                {
