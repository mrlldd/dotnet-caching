...
namespace mrlldd.Caching.Extensions.DependencyInjection
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        ///     The assembly that contains implemented cached utilities and used in order to collect those
        ///     types and add them to container.
        /// </param>
            ...
            params Assembly[] assemblies)
        {
            ...
            var types = assemblies
                ...
                .ToArray();
            services.TryAddScoped<IStoreOperationOptionsProvider, StoreOperationOptionsProvider>();
