...
namespace mrlldd.Caching.Extensions.DependencyInjection
{
    ...
    /// </summary>
    public interface ISerializersCachingServiceCollection : ICachingServiceCollection
    {
        /// <summary>
        ...
        ISerializersCachingServiceCollection Use(ICachingSerializer serializer);
        ...
        /// <returns>The service collection.</returns>
        ISerializersCachingServiceCollection Use(Func<IServiceProvider, ICachingSerializer> serializerFactory, ServiceLifetime scope = ServiceLifetime.Scoped);
        ...
        /// <returns>The service collection.</returns>
        ISerializersCachingServiceCollection Use<T>(ServiceLifetime scope = ServiceLifetime.Scoped) where T : class, ICachingSerializer;
    }
